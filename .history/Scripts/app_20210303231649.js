...
((core) =>
{
    ...
    function validateFirstname()
    {
      ...
      let firstNamePattern = /([A-Z][a-z]{1,25})+(\s|,|-)([A-Z][a-z]{1,25})+(\s|,|-)*/;
        ...
        $("#firstName").on("blur", function()
        {
          ...
          {
            $(this).trigger("focus").trigger("select");
            ErrorMessage.show().addClass("alert alert-danger").text("Please enter a valid Name. This must include at least a Capitalized first name followed by a Capitlalized last name.");
          }
          else
          {

    ...
    function toggleLogin()
    {
      ...
      if(sessionStorage.getItem("user"))
      {
        ...
        if(sessionStorage.getItem("user"))
        {
          ...
          $(`<li class="nav-item">
          <a id="sessionName" class="nav-link" aria-current="page" href="#"><i class="fas fa-lg"></i></a>
          </li>`).insertBefore("#login");

          $("#sessionName").text(sessionUser);

          //document.getElementById("#sessionName").innerHTML = sessionUser;
        }

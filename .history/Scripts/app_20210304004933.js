...
((core) =>
{
    ...
    function validateEmailAddress()
    {
      ...
      let ErrorMessage = $("#ErrorMessage").hide();
      let firstNamePattern = /([A-Z,a-z,0-9]{8})+(\s|@)/;
    ...
    function validatePassword()
    {
      ...
      let firstNamePattern = /([A-Z,a-z,0-9]{8})+(\s|@)/;
        ...
        $("#passwordReg").on("blur", function()
        {
          ...
          {
            $(this).trigger("focus").trigger("select");
            ErrorMessage.show().addClass("alert alert-danger").text("The entered Password is invalid. It must contain at least 8 characters and @ sign.");
          }
          else
          {
            ErrorMessage.removeAttr("class").hide();
